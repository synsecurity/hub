Parses timestamp strings in logs to be used in [forensic mode](https://doc.synsec.net/Crowdsec/v1/user_guide/forensic_mode/). The following formats are currently supported :
